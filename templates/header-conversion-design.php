...
<div class="jumbotron jumbotron-fluid bg-gradient-millenium-pine overflow-hidden mb-0">
  <div class="container text-center text-white">

    <div class="row">
      <div class="col-12">
        <h1 class="display-5 my-6">Persuasive Design build for Mobile and Desktop Jada jada jada</h1>
      </div>
    </div>

    <div class="row justify-content-center">
      <div class="col-9">
        <p class="lead">We’ll let the insights and data guide us when we start working on fixing what matters most to your customers</p>
      </div>
    </div>
