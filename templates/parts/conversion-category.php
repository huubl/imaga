...
<div class="container py-4">
  <div class="row text-center">
    <div class="col-3 <?= get_field('conversion_category') == 'conversion-research' ? "conversion-arrow$color" : '' ; ?>">
    ...
    <div class="col-3 <?= get_field('conversion_category') == 'conversion-strategy' ? "conversion-arrow$color" : '' ; ?>">
    ...
    <div class="col-3 <?= get_field('conversion_category') == 'conversion-design' ? "conversion-arrow$color" : '' ; ?>">
    ...
    <div class="col-3 <?= get_field('conversion_category') == 'conversion-build' ? "conversion-arrow$color" : '' ; ?>">
