...
<section id="conversions" class="<? the_field('conversion_bg'); ?>">
  <div class="container py-4">
    <div class="row text-center">
      ...
      <a class="col-3 conversion-category-item" href="/conversion-optimization/conversion-research#content">
      ...
      <a class="col-3 conversion-category-item" href="/conversion-optimization/conversion-strategy#content">
      ...
      <a class="col-3 conversion-category-item" href="/conversion-optimization/conversion-design#content">
      ...
      <a class="col-3 conversion-category-item" href="/conversion-optimization/conversion-build#content">
