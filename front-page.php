  ...
  <div class="container">
    ...
    <div class="row py-md-2">
      <div class="col-12 col-md-6 pr-md-5">
        <h1 class="display-1 mb-4">Is your website leaking money?</h1>
      ...
      <div class="col-12 col-md-6 bg-blue d-block d-md-none">
        <img class="img-fluid" src="<? the_post_thumbnail_url(); ?>" alt="<? the_title(); ?>">
      </div>
    </div>

  </div>
  <div class="bg-right bg-contain bg-center-bottom bg-blue d-none d-md-block" style="background-image: url('<? the_post_thumbnail_url(); ?>');"></div>
...
<section id="how-we-can-help" class="how-we-can-help bg-light">
    <div class="container text-center">
      <div class="row py-3">
        <div class="col-12">
          <h2 class="display-1">How can we help you and your team?</h2>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-12 col-md-6">
          <a href="#i-want-to-improve" class="btn btn-green btn-lg">
  ...
  <div class="container overflow-hidden">
    ...
    <div class="row">
      <div class="col-12 text-center pb-5">
        <h2 class="display-2">Discover insights that matters to your bottom line<br>with our Conversion Optimization Process</h2>
    ...
    <div class="row text-center">
      <div class="col-12 col-md-3 conversion-arrow">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h2 class="display-1">Your data is a strategic resource</h2>
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-7 py-4 px-md-0">
