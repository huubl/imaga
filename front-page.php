...
<section>
  <div class="container overflow-hidden">
    ...
    <div class="row">
      <div class="col-12 text-md-center pb-5">
    ...
    <div class="row text-center conversion-brands">
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-7 py-4 px-md-0">
        <ul class="list-unstyled">
          <li>
            <h4 class="display-2">
              <i class="fa fa-check"></i> Who is your customer?
            </h4>
          </li>
          <li>
            <h4 class="display-2">
              <i class="fa fa-check"></i> What motivates them?
            </h4>
          </li>
          <li>
            <h4 class="display-2">
              <i class="fa fa-check"></i> What goals are they trying to reach?
            </h4>
          </li>
          <li>
            <h4 class="display-2">
              <i class="fa fa-check"></i> And how can your company help them best?
            </h4>
          </li>
        </ul>
      </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-12 col-md-3">
        <h2 class="lead mb-4">Or select any of the other steps of our conversion process</h2>
      </div>
